    ...
    return (<div className='flex items-center justify-center min-h-screen bg-gray-100'>
      <div className='w-80 rounded-lg shadow h-auto p-6 bg-white relative overflow-hidden'>
        ...
        <form className='w-full mt-4 space-y-3'>
          <div>
            <input className='outline-none border-2 rounded-md px-2 py-1 text-slate-500 w-full focus:border-blue-300' placeholder='Username' id='username' name='username' type='text' required/>
          </div>
          <div>
            <input className='outline-none border-2 rounded-md px-2 py-1 text-slate-500 w-full focus:border-blue-300' placeholder='Password' id='password' name='password' type='password' required/>
          </div>
